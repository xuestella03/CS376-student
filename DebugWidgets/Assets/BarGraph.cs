...
public class BarGraph : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var barTransform = GetComponentInChildren<RectTransform> ();
        var barWidth = barTransform.sizeDelta.x * barTransform.localScale.x;
        if (signedDisplay)
        {
            BarImage.transform.localPosition = new Vector3(BarImage.transform.localPosition.x + (barWidth / 2.0f), BarImage.transform.localPosition.y, BarImage.transform.localPosition.z);
        }
    }
