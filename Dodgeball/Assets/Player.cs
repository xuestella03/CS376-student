...
public class Player : MonoBehaviour
{
    ...
    private void FireOrb()
    {
        ...
        orb.transform.Translate(x: 1, y: 0, z: 0);

        var orbBody = orb.GetComponent<Rigidbody2D>();
        orbBody.velocity = OrbVelocity * direction;
    ...
    void Manoeuvre()
    {
        ...
        self.AddForce(new Vector2(hAxis, vAxis) * EnginePower);

        var rotate = Input.GetAxis("Rotate");
        self.angularVelocity = rotate * RotateSpeed;
    }
